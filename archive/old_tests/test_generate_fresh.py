...
def main():
    ...
    # Let's apply deterministic rules first or second?
    # Usually we apply deterministic rules first, so large paragraphs are replaced
    # by narrative tags, then we apply AI mappings for the remaining text.
