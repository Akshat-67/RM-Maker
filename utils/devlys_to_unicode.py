...
class DevLysToUnicodeConverter:
    ...
    _punct_cleaner = re.compile(r'^[^A-Za-z0-9]+|[^A-Za-z0-9]+$')
    ...
    def is_likely_english(text):
        ...
        for w in words:
            ...
            w_clean = DevLysToUnicodeConverter._punct_cleaner.sub('', w)
            if not w_clean:
                continue
            ...
            # Early return: if any word doesn't match English patterns, it's not entirely English
            return False

        # If all valid words look like English, it's English
