...
class DevLysToUnicodeConverter:
    ...
    # Pre-compiled regexes for performance optimization in hot paths
    ...
    _matra_regex = re.compile(r'ि((?:[\u0900-\u097F]्)*[\u0900-\u097F])')
    ...
    def is_likely_english(text):
        ...
        for w in words:
            ...
            w_clean = DevLysToUnicodeConverter._clean_punctuation_regex.sub('', w)
            if not w_clean:
                continue
            if w_clean.isdigit():
    ...
    def devlys_to_unicode_text(text):
        ...
        modified = DevLysToUnicodeConverter._matra_regex.sub(r'\1ि', modified)
