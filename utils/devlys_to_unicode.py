...
class DevLysToUnicodeConverter:
    ...
    _english_char_regex = re.compile(r'^[A-Za-z0-9\s\.,\-\(\)\/\#\&\:\@]+$')
    ...
    def is_likely_english(text):
        ...
        if not DevLysToUnicodeConverter._english_char_regex.match(stripped):
            return False
        ...
        for w in words:
            ...
            is_english_words = True # At least one valid word to process
            ...
            return False # Early exit, not English
