    ...
    def proofread(docx_text: str, session_data: dict, ocr_text: str = "", legal_text: str = "", tech_text: str = "") -> list[Discrepancy]:
        ...
        try:
            ...
            prompt = (
                ...
                "6. Check for duplicate words or prefixes/suffixes (e.g., 'Mr. Mr.', 'Rupees Rupees', '/- /-', 'Only Only').\n"
                "7. Verify that critical sections or relative associations are not missing.\n"
                "8. Identify mismatched details (e.g., swapped details between borrowers).\n\n"
