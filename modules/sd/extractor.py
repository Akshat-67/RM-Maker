...
class SDDataExtractor:
    ...
    def _run_gemini_extraction(self, file_paths, selected_model, prompt):
        ...
        pdf_keywords = ["boundaries", "khasra", "plot", "flat", "covenant", "schedule", "seller", "buyer", "purchaser", "witness", "consideration", "latitude", "longitude"]
        ...
        for path in effective_paths:
            ...
            if ext == '.pdf':
                ...
                if selected_pages:
                    print(f"[SD Extractor] Searchable PDF detected: {filename}. Sending selected pages text: {selected_pages}")
                    ...
                    print(f"[SD Extractor] Scanned/non-searchable PDF: {filename}. Sending full file bytes.")
                    with open(path, 'rb') as f:
                        raw = f.read()
    ...
    def _normalize_final_data(self, data, expected_sellers, expected_buyers, expected_witnesses):
        ...
        self._normalize_list(data, "unassigned_aadhars", ["s", "n", "n_en", "a", "dob", "r", "rn", "rn_en", "relation_text", "adr", "adr_en", "id", "pan", "files"])
    ...
    def _normalize_sd_response(self, data, expected_sellers, expected_buyers, expected_witnesses):
        ...
        self._normalize_list(data, "unassigned_aadhars", ["s", "n", "n_en", "a", "r", "rn", "rn_en", "relation_text", "adr", "adr_en", "id", "pan", "is_bpl", "files"])
